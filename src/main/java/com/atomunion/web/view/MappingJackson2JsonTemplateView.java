 ...
 */
public class MappingJackson2JsonTemplateView extends MappingJackson2JsonView {
	 ...
	 */
	public MappingJackson2JsonTemplateView() {
		super();
	}
	...
	protected Object filterModel(Map<String, Object> model) {
		if(model.containsKey("JSONTemplate")){
			Object obj = model.get("JSONTemplate");
			if(Validate.isInstanceOf(JSONTemplate.class, obj)) {
				return ((JSONTemplate)obj).getData();
			}
		}
